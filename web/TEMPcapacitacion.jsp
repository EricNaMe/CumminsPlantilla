...
<div class="col-xs-3 tabs-left"> <!-- required for floating -->
    ...
    <ul class="nav nav-tabs tabs-left cumminsTabs" >
	  	...
	  	<li ><a  href="TEMPCapacitacionMecanico.jsp">Mecánicos</a></li>
	  	<li ><a  href="TEMPCapacitacionAdminGarantias.jsp">Administrador de Garantiawws</a></li>
	  	<li ><a  href="TEMPCapacitacionJefeTaller.jsp">Jefe de Taller</a></li>
