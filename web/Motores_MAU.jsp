            ...
            <div class="container-body" style="margin: 20px">
                <div class="row">
                    <div class="col-sm-4 form-inline">
                        ...
                        <input type="text" id="motor" value="ISX" style="width: 150px;" class="form-control"/>
                    </div>
                    <div class="col-sm-3">
                        <button type="button" class="btn btn-default">Importar de Infant/Teen</button>
                    </div>
                    <div class="col-sm-2">
                        <button type="button" class="btn btn-default">Guardar</button>
                    </div>	
                    <div class="col-sm-3">
                        <button type="button" class="btn btn-default">Salir y Cancelar</button>
                    </div>
                </div>
                <br><br>
                <label for="NumEval">Rango</label>
                <select id ="NumEval" class="form-control" style="width:100px;">
                    <option value="volvo">HD</option>
                ...
                <div class="container-body col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <form class="form-horizontal" role="form">
                        <div id="toolbar">
                            <label for="motorAdd" class="col-sm-2">Motor </label>
                            <input type="text" id="motorAdd" style="width: 150px;" class="form-control col-sm-3"/>&nbsp;
