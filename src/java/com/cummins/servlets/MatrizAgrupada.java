...
import com.cummins.jacksonMatriz.Data;
import com.cummins.jacksonMatriz.JsonMatriz;
 ...
 * @author nc784
 */
public class MatrizAgrupada extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        JsonMatriz jsonMatriz = new JsonMatriz();
        ...
        try {
            ...
            System.out.println("MatrizAgrupada::processRequest SQLException: " + sqlEx);
        } catch (NumberFormatException numEx) {
            System.out.println("MatrizAgrupada::processRequest NumberFormatException: " + numEx);
        } catch (Exception e) {
            System.out.println("MatrizAgrupada::processRequest Exception: " + e);
        } finally {
            if (conn != null) {
                try {
                    conn.close();
    ...
    public ArrayList<Data> obtenerMatriz() throws Exception {
        ...
        while (rsListaMatriz.next()) {
            data = new Data();
            data.setMatrizId(rsListaMatriz.getString("ID_MATRIZ"));
