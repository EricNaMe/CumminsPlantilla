 ...
 * @author nc784
 */
public class ObtenerCalJefeTaller extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            System.out.println("Consiguiendo Calificado Jefe Taller");
            session = request.getSession();
            conn = Conexion.getDS().getConnection();
            conn.setAutoCommit(false);
            jsonCapacitaJefeTaller.setData(obtenerCalJT());
    ...
    public ArrayList<Data> obtenerCalJT() throws Exception {
        ArrayList<Data> alListaMatriz = new ArrayList<Data>();
        CallableStatement csObtenerMatriz = null;
        ResultSet rsListaMatriz = null;
        Data data;
        System.out.println("Ejecutando Procedimiento ObtenerCalJefeTaller");
        csObtenerMatriz = conn.prepareCall("{ call ZMKT.ZMKT7257_DES_TEST_PKG.OBT_CAL_JEFE_TALLER(?)}");
        ...
        while (rsListaMatriz.next()) {
            ...
            data.setNomJefeTaller(rsListaMatriz.getString("MATRIZ_NAME"));
