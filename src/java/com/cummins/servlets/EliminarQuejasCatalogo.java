 ...
 * @author nc784
 */
public class EliminarQuejasCatalogo extends HttpServlet {
    ...
    private void eliminar() throws SQLException {
        CallableStatement csEliminarMotor = conn.prepareCall("{ call ZMKT.ZMKT7257_DES_TEST_PKG.ELIMINAR_QUEJAS_CATALOGO(?)}");
