 ...
 * @author nc784
 */
public class ObtenerMotoresOpc extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String strIdDealer = "";
        try {
            System.out.println("Consiguiendo Lista Motores Opcionales");
            ...
            if (!"".equals(strIdDealer) || strIdDealer != null) {
                ...
                jsonMotores.setData(obtenerMotoresOpc());
            }
            ...
            System.out.println("ObtenerMotoresOpc::processRequest SQLException: " + sqlEx);
        } catch (NumberFormatException numEx) {
            jsonMotores.setMessage("No se pudo extraer la lista de los programas");
            System.out.println("ObtenerMotoresOpc::processRequest NumberFormatException: " + numEx);
        } catch (Exception e) {
            jsonMotores.setMessage("No se pudo extraer la lista de los programas");
            System.out.println("ObtenerMotoresOpc::processRequest Exception: " + e);
        } finally {
            if (conn != null) {
                try {
                    conn.close();
    ...
    public ArrayList<Data> obtenerMotoresOpc() throws Exception {
        ArrayList<Data> alListaMotor = new ArrayList<Data>();
        CallableStatement csObtenerMotores = null;
        ResultSet rsListaMotores = null;
        Data data;
        System.out.println("Ejecutando Procedimiento Obtener Motores Opcionales");
    ...
    public ArrayList<Data> obtenerMotoresOblPerfil(String strIdDealer) throws Exception {
        ...
        ResultSet rsListaMotores = null;
        Data data;
        System.out.println("Ejecutando Procedimiento Obtener Motores Opcionales Perfil");
        ...
        csObtenerMotores.setString(3, "ND");
