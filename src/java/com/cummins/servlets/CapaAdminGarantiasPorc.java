 ...
 * @author nc784
 */
public class CapaAdminGarantiasPorc extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            System.out.println("Consiguiendo Calificado Admin Garantias Porcentaje");
    ...
    public ArrayList<Data> obtenerMatriz() throws Exception {
        ...
        Data data;
        System.out.println("Ejecutando Procedimiento Admin Garantias Porcentaje");
        csObtenerMatriz = conn.prepareCall("{ call ZMKT.ZMKT7257_DES_TEST_PKG.CAPA_ADMIN_GARANTIAS_PORC(?)}");
        ...
        while (rsListaMatriz.next()) {
            ...
            data.setPorcLogrado(rsListaMatriz.getString("MATRIZ_NAME"));
